...
Route::get('customer-invoice-process', 'backend\TruckController@customer_invoice_process')->name('customer-invoice_process');
Route::POST('customer-invoice-save', 'backend\TruckController@save_customer_invoice')->name('save-customer-invoice');
