                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-3 form-group">
                                                        <label for="">Return Sales No</label>
                                                        <input type="text" class="form-control" name="sale_return_no" id="sale_return_no" value="{{ $new_return->sale_return_no }} " required>
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Return Date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" name="return_date" id="return_date" required>
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <label class="invoice-label" for="">Av. Sale QTY</label>
                                                        <input type="number" class="form-control" name="av_quantity"
                                                            id="av_quantity" readonly>
                                                    </div>
                                                    <div class="col-sm-2">
                            ...
                            <div class="row">
                                ...
                                <div class="invoice-items">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('saleReturnPrint', $return->id) }}" target="_blank">{{ $return->sale_return_no }}</a></li>
        ...
        $(document).ready(function() {
            ...
            $(document).on("keyup", "#invoice_no", function(e) {
                ...
                if ($(this).val().length > 10) {
                    var sale_return = $('#sale_return_no').val();

                    var value = $(this).val();
                    var _token = $('input[name="_token"]').val();

                    $.ajax({
                        url: "{{ route('findsaleInvoice') }}",
                        method: "POST",
                        data: {
                            value: value,
                ...
                if ($(this).val() != '') {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#av_quantity").val(response.av_qty);
            ...
            $('#temp_sale_return').click(function() {
                // alert(1);
                var sale_return_no = $('#sale_return_no').val();
                var item_name = $('#item_name').val();
