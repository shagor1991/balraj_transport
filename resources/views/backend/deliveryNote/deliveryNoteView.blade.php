                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                            ...
                                                            <form action="{{ route('asignDeliveryNote', $invoice) }}" method="POST">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        ...
                                                                        <input type="text" name="note_no" class="form-control" list="browsers"
                                                        ...
                                                        <div class="col-sm-3 form-group">
                                                            ...
                                                            <p>
                                                                <a href="{{ route('deliveryNoteInvoice',$deliveryNote->DInvoice) }}" class="btn btn-info btn-sm">{{ $deliveryNote->DInvoice->invoice_no }}</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
