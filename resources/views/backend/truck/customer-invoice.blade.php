        ...
        <div class="content-wrapper">
            <div class="content-body">
                <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                    ...
                    <a href="{{route("customer-invoice")}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false" id="mJournalAuthorizationSection">
                        <div class="master-icon text-cente">
                                        ...
                                        <div class="col-12">
                                            <div class="cardStyleChange p-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="date" name="from" class="inputFieldHeight form-control" id="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="date" name="to" class="inputFieldHeight form-control" id="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-responsive" style="min-height: 300px">
                                                    <form action="{{ route('customer-invoice_process')}}" method="get">
